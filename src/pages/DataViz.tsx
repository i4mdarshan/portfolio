...
import PageDetailsSectionTitle from "@/components/sections/ProjectDetailsSectionTitle";
...
function ProjectDetailsSectionTitle({
  children,
}: {
...
// ── Main Component ────────────────────────────────────────────────────────────
const DataViz = () => {
  const pageSubSectionCaption = "Power BI * Data Case Study";
  const pageSubSectionTitleFocus = "Uber";
  const pageSubSectionTitleItalics = "Analytics";
  const pageSubSectionDescription =
    "A Power BI report built to solve real operational problems from booking loss analysis and vehicle profitability to rider retention, payment behaviour, and location demand forecasting.";
      ...
      <ProjectDetailsPageContainer>
        ...
        <PageSection>
          ...
          >
            ...
            >
              Use the page tabs inside the report to navigate all 5 sections.
              Toggle the filter panel (☰) for vehicle, date, and location
              drill-down.
            </p>
          </motion.div>
        ...
        <PageSection id='section-overview' ref={overviewRef}>
          <motion.div
            variants={fadeUp}
            initial='hidden'
          ...
          >
            ...
            <p
              ...
              style={{ opacity: 0.55, fontSize: "1rem" }}
            >
              The overview page gives ops managers an instant read on platform
              health. But beneath the top-line figures lies a 38% loss rate and
              a rating gap that signals driver experience friction.
            </p>
          </motion.div>
                ...
                <div key={v.type} className='flex items-center gap-4'>
                  ...
                  >
                    <motion.div
                      ...
                      initial={{ width: 0 }}
                      animate={
                        overviewInView ? { width: `${v.pct}%` } : { width: 0 }
                      }
                      transition={{
                        duration: 1,
                        delay: 0.3 + i * 0.1,
        ...
        <PageSection id='section-vehicle' ref={vehicleRef}>
          <motion.div
            variants={fadeUp}
            initial='hidden'
          ...
          >
            ...
            >
              ...
              high-volume, low-fare dominance to Uber XL's niche, premium-fare
              profile. The vehicle page makes these trade-offs visible and
              filterable.
            </p>
          </motion.div>
        ...
        <PageSection id='section-revenue' ref={revenueRef}>
          <motion.div
            variants={fadeUp}
            initial='hidden'
          ...
          >
            ...
            >
              ...
              type, vehicle category, payment method, and time. Each cut reveals
              a different lever for growth.
            </p>
          </motion.div>
        ...
        <PageSection id='section-rider' ref={riderRef}>
          <motion.div
            variants={fadeUp}
            initial='hidden'
          ...
          >
            ...
            >
              ...
              segment distribution, and payment preferences turning support data
        ...
        <PageSection id='section-location' ref={locationRef}>
          <motion.div
            variants={fadeUp}
            initial='hidden'
          ...
          >
            ...
            >
              ...
              intelligenceidentifying zones and time slots that drive the most
              volume so drivers can be positioned proactively, not reactively.
            </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-10'>
            {locationInsights.map((l, i) => (
              <motion.div
                ...
                style={{ border: "1px solid rgba(0,0,0,0.08)" }}
              >
                <span className='text-2xl mb-4 block' style={{ opacity: 0.65 }}>
                  {l.icon}
                </span>
                ...
                <p className='text-xs font-mono mb-3' style={{ opacity: 0.65 }}>
                  {l.unit}
                </p>
                <p
                  className='font-semibold mb-2'
          ...
          >
            ...
            <div className='relative h-44 flex items-end gap-1.5'>
              ...
              {(
                ...
                const values = [
                  210, 131, 233, 227, 247, 239, 221, 256, 230, 245, 224, 204,
                ];
                const minH = 45,
                  maxH = 88;
        ...
        <PageSection className='pb-24'>
          ...
          >
            ...
            >
              ...
              cancellations, and two location hotspots that should anchor every
              driver positioning decision."
            </p>
