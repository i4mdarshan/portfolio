...
const skills = [
  ...
  { name: "CPP", category: "Backend", level: 84 },
  { name: "Laravel", category: "Frontend", level: 93 },
  { name: "Jenkins", category: "API", level: 81 },
  { name: "SpringBoot", category: "DevOps", level: 78 },
  { name: "MongoDB", category: "Database", level: 85 },
  { name: "JavaScript", category: "Database", level: 82 },
  { name: "PHP", category: "Frontend", level: 89 },
  { name: "Scikit-Learn", category: "ML/AI", level: 79 },
