  ...
  return (
    <>
      <ProjectDetailsPageContainer>
        ...
        <section id='section-overview' ref={overviewRef} className='py-4 px-6'>
          <div className='container mx-auto max-w-6xl'>
            <motion.div
              variants={fadeUp}
              initial='hidden'
            ...
            >
              ...
              >
                ...
                health. But beneath the top-line figures lies a 38% loss rate
                and a rating gap that signals driver experience friction.
              </p>
            </motion.div>
        ...
        <section id='section-location' ref={locationRef} className='py-4 px-6'>
          <div className='container mx-auto max-w-6xl'>
            <motion.div
              variants={fadeUp}
              initial='hidden'
